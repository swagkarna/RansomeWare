# Major - Meduim & Functionnal Update
...
# Minor & GUI Update
# TODO - Change hilighting when select button color #  Do ?
# TODO - Change color of DOGMA titel # Do ?
# TODO - Change color of TIME REAMING # Do  ?
...
class Form:
    ...
    def toplevel2(self):
        ...
        if self.user_input == "12345":
            ...
            self.b_quit = Button(self.top2, text="Quit", command=quit,
                                 fg="gray17", bg="gold")
